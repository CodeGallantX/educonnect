      ...
      <div className="flex flex-col text-white gap-5 px-16 lg:px-10 xl:px-24 py-12 lg:py-8">
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-3 lg:gap-6'>
          ...
          <fieldset className="flex flex-col items-start justify-center gap-1">
            ...
            <input
              className="w-full border border-solid py-3 px-3 rounded border-white bg-gray-800 outline-none focus:ring-1 focus:ring-primary focus:border-none transition-all duration-300 ease-in-out text-white"
              type="email"
              name="email"
              id="email"
          ...
          <div className="flex flex-row items-center justify-between">
            <div className="flex flex-row items-center gap-2">
              <input
                ...
                onChange={handleChange}
              />
              <label htmlFor="agree" className="text-white">I agree to all the <a className="font-bold underlined">terms and conditions</a>.</label>
            </div>
          </div>
          ...
          <p className="text-white">Already have an account? <Link href="/login" className='font-bold underlined transition duration-300 ease-in-out'>Log in</Link></p>
        </form>
