...
const Header = () => {
    return (
        <header className="flex flex-wrap items-center justify-between space-x-10 py-4 px-4 md:px-6 lg:px-16 xl:px-24 bg-gray-900">
            ...
            <nav className="hidden sm:flex space-x-6 ml-auto">
                ...
                <Link href="/post" className="text-gray-400 hover:text-gray-600 hover:text-white">
                    <PiNotePencilBold className="text-2xl" />
                </Link>
                <Link href="/community" className="text-gray-400 hover:text-gray-600 hover:text-white">
