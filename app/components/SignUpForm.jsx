...
const App = () => {
  ...
  return (
    <div className='lg:grid lg:grid-cols-2 bg-gray-800 w-full h-screen overflow-hidden'>
      <div className="w-full flex flex-col text-white space-y-3 px-10 md:px-16 lg:pl-16 lg:px-0 xl:pl-16 xl:pr-16 py-10 lg:py-8">
      ...
      <div className='hidden overflow-hidden lg:block ml-auto lg:w-5/6 xl:w-11/12 relative h-full bg-gradient-to-tr from-cyan-800 to-purple-900'>
        ...
        <div className='absolute text-white w-full bottom-20 xl:bottom-1/4 left-1/2 -translate-x-1/2'>
          <div className="flex flex-col space-y-4 items-center text-center px-8">
            ...
            <blockquote className="text-lg xl:text-2xl">Post questions in any subject and get clear, reliable answers from students and contributors. Learning starts with a single question.</blockquote>
          </div>
        </div>
      </div>
    </div>
